...
<title>Payment | HiBookAdmin</title>
</head>
<body class="bg-light">
	...
	<div class="d-flex">
		...
		<div class="content p-4">
			...
			<h2 class="mb-4">Datatable Thanh Toán</h2>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="col-12">
							<label for="validationServer01">Tên loại thanh toán</label> <input
								...
								id="validationServer01" placeholder="Name payment*" required>
					...
					<div class="modal-footer">
						<button id="close-add-payment" type="button"
							class="btn btn-secondary" data-dismiss="modal">Close</button>
						<button id="save-add-payment" class="btn btn-success">Save</button>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="modal-body">
						<div class="col-12">
							<h5 id="xoa-title" class="modal-title">Bạn có chắc muốn xóa
								loại thanh toán này không?</h5>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
						<button id="delete-payment" class="btn btn-success">Delete</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="resources/js/admin-api/Admin_Payment.js"></script>
	...
	<!-- CUSTOM JS AJAX  -->
	<!-- <script src="resources/js/user-custom/getListpayment.js"></script> -->
