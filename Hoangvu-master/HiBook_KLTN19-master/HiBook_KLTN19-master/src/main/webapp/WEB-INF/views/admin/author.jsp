...
<title>Tour | BookTourAdmin</title>
</head>
<body class="bg-light">

	<nav class="navbar navbar-expand navbar-dark bg-success">
		<a class="sidebar-toggle mr-3" href="#"><i class="fa fa-bars"></i></a>
		<a class="navbar-brand" href="#" style="font-weight: bold;">BookTour</a>
	...
	<div class="d-flex">
		...
		<div class="content p-4">
			...
			<h2 class="mb-4">Datatable Lịch Trình</h2>
			<div width="100%" style="text-align: right;">
				<a id="add-author" href="#"
					class="btn btn-icon btn-pill btn-success" data-toggle="modal"
					data-target="#modalAdd"> <i class="fa fa-fw fa-plus"></i> Thêm Lịch Trình
				</a>
			</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalCenterTitle">Thêm Lịch Trình</h5>
					...
					<div class="modal-body">
						<div class="col-12">
							<label for="validationServer01">Thêm Lịch Trình</label> <input
								type="text" class="form-control is-valid"
								id="validationServer01" placeholder="Lịch trình" required>
							<div class="invalid-feedback" style="display: none;">Hãy
								nhập tên Lịch trình</div>
